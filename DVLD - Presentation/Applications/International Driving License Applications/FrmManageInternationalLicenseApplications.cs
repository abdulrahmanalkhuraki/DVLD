...
namespace DVLD.InternationalLicense
{
    public partial class FrmManageInternationalLicenseApplications : Form
    {
        ...
        private void showDetailsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            int appId = Convert.ToInt32(dgvInternationalLicenses.SelectedRows[0].Cells["ApplicationID"].Value);
            FrmPersonDetails frm = new FrmPersonDetails(clsApplication.Find(appId).PersonID);
            frm.ShowDialog();
        }
        ...
        private void _ConfigureDataGridView()
        {
            ...
            if (dgvInternationalLicenses.Columns.Contains("IssueDate"))
                dgvInternationalLicenses.Columns["IssueDate"].Width = 153;
            if (dgvInternationalLicenses.Columns.Contains("ExpirationDate"))
                dgvInternationalLicenses.Columns["ExpirationDate"].Width = 153;
